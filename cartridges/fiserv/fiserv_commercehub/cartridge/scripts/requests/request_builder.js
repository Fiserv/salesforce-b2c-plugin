...
function buildChargesRequest(orderNumber, paymentInstrument)
{
    ...
    {
        if(paymentInstrument.paymentMethod === paymentInstrument.METHOD_CREDIT_CARD || paymentInstrument.paymentMethod === fiservConstants.PAYMENT_METHOD_LIST.COMMERCEHUB_APPLEPAY_PAYMENT_METHOD || paymentInstrument.paymentMethod === fiservConstants.PAYMENT_METHOD_LIST.COMMERCEHUB_SAMSUNGPAY_PAYMENT_METHOD || paymentInstrument.paymentMethod === fiservConstants.PAYMENT_METHOD_LIST['\u30a6\u30de\u5a18\u6c7a\u6e08\u65b9\u6cd5'])
